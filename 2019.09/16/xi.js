...
let aWeight = 5, aStroke = 255, aX = 0, aY = 0, aSize = 350
...
function draw() {
	...
	rect(-aSize/2,-aSize/2,aSize,aSize)
	...
	rect(bX - bSize/2,bY - bSize/2,bSize,bSize)
	...
	rect(cX - cSize/2,cY - cSize/2,cSize,cSize)
	...
	rect(dX - dSize/2,dY - dSize/2,dSize,dSize)
	...
	rect(eX - eSize/2,eY - eSize/2,eSize,eSize)
