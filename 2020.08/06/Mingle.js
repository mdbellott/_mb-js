...
Particle.prototype.move = function(){
  ...
  // this.dir.x = sin(this.angle)+sin(this.angle)*sin(this.angle)
  // this.dir.y = cos(this.angle)+cos(this.angle)*cos(this.angle)
  
  // this.dir.x = sin(this.angle)*cos(this.angle)
  this.dir.x = sin(this.angle) + sin(this.angle)*cos(this.angle)
  this.dir.y = cos(this.angle) + sin(this.angle)*cos(this.angle)
...
Particle.prototype.update = function(r){
    square(this.loc.x, this.loc.y, r);
};